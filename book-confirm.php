...
<head>
  ...
  <button class="navbar-toggler" data-toggle="collapse" data-target="#ulli">
    ...
    <form style="margin-top:160px;" class="text-center" action="checkout.php?price=<?php echo $total?>" method="POST">
      <div class="row">
        <div class="col-md-3">
        ...
        <div style="font-size:22px; background:#00000045;  word-spacing: 2px;" class="col-md-3 py-5 border border-primary text-white">
          <p> <b>Movie Name: </b> <i><?php echo "$movie_name"; ?></i> </p>
          ...
          require_once("connect.php");
           ...
           $insertQuery="INSERT INTO booking(name,phone,screen,seat,price,status,movie_name) VALUES('$name','$mobile','$screen','$seat','$price','$status' ,'$movie_name')";
