  ...
  <div class="col-md-8 ml-5">
    ...
    <table style="width:1000px;" class="text-light text-center bg-dark"">
      <tr>
        ...
        <td class="p-3" style="font-size:22px;"><b>Name</b></td>
        <td class="p-3" style="font-size:22px;"><b>Phone No.</b></td>
        <td class="p-3" style="font-size:22px;"><b>Screen</b></td>
        <td class="p-3" style="font-size:22px;"><b>Seat</b></td>
        <td class="p-3" style="font-size:22px;"><b>Price</b></td>
        <td class="p-3" style="font-size:22px;"><b>Movie Name</b></td>
