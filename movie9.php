<li class="list-inline-item">
  <div class="card">
      <div class="imgBx">
        <a href="#" data-toggle="modal" data-target="#mvdetails-9"><img  src="avatar/trending/<?php echo $row["avatar"]; ?>" alt="" class="explore-image image2" height="230px" width="240px"></a>
      </div>



      <div class="modal" id="mvdetails-9">
       <div class="modal-dialog">
         <div class="modal-content">
           <div class="modal-header bg-danger">
             ...
             <div class="imgBx">
               <a href="#"><img  src="avatar/trending/<?php echo $row["avatar"]; ?>" alt="" class="explore-image image1" height="160px" width="180px"></a>
             </div>
      ...
      <div class="modal" id="mvdetails-2">
       <div class="modal-dialog">
         <div class="modal-content">
           <div class="modal-header bg-danger">
             <h4 class="modal-title text-light display-4">
         ...
         <div class="modal-header bg-info">
           ...
           <div class="modal-body">
            ...
            <form class="text-left text-light" action="book-confirm.php" method="POST">
              ...
              <input type="hidden" name="movie_name" value="<?php
              echo $row["movie"];
              ?>">
              <div class="form-group">
