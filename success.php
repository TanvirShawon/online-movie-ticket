                     ...
                     <div class="col-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <a href="http://localhost/website_project/ticket.php"><button  style="margin-left:35px;"class="text-center " type="button" name="button" target="ticket.php">Ticket</button></a>
                        </div>
                      </div>
                      <br><br>
