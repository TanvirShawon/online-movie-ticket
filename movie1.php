...
<li class="list-inline-item">
  <div class="card">
      <div class="imgBx">
        <a href="#" data-toggle="modal" data-target="#mvdetails-1"><img  src="avatar/trending/<?php echo $row["avatar"]; ?>" alt="" class="explore-image image1" height="230px" width="240px"></a>
      </div>
  ...
  <div class="pt-2 mb-3 text-center">
   ...
   <div class="modal" id="mvdetails-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-danger">
          <h4 class="modal-title text-light display-4">
