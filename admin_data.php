                ...
                <div class="col-md-5">
                  <form class="bg-light border border-dark" action="savedata_core.php" method="post" >
                    ...
                    <hr>
                          ...
                          <div class="container">
                            <div class="form-group px-5 border border-info py-2">
                                <input type="text" name="characters" value="" placeholder="Characters" class="form-control text-center">
                            </div>
                          </div>
                          ...
                          <div class="container">
                            <div class="form-group px-5 border border-info py-2">
                                <input type="text" name="directors" value="" placeholder="Directors" class="form-control text-center">
                            </div>
                          </div>
                          ...
                          <div class="container">
                            <div class="form-group px-5 border border-info py-2">
                                <input type="text" name="cast" value="" placeholder="Cast" class="form-control text-center">
                            </div>
                          </div>
