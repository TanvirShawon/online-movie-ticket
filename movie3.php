<li class="list-inline-item">
  <div class="card">
      <div class="imgBx">
        <a href="#" data-toggle="modal" data-target="#mvdetails-3"><img  src="avatar/trending/<?php echo $row["avatar"]; ?>" alt="" class="explore-image image2" height="230px" width="240px"></a>
      </div>



      <div class="modal" id="mvdetails-3">
